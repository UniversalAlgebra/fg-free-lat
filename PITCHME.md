...
**Proposition.**
If $h\colon \mathbf{F} \twoheadrightarrow \mathbf{M_3}$ is generated by $x\mapsto a$, $y\mapsto b$, $z\mapsto c$, then 

$\qquad \operatorname{ker} h$ is not finitely generated.
