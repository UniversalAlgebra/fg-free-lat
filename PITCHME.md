...
Let $\mathbf L = \langle L, \vee, \wedge\rangle$ be a lattice 
generated by a finite set $X$.
  
Then $L$ is a union of the chain $\qquad H_0\subseteq H_1 \subseteq H_2 \subseteq \cdots$ defined by
...
**Proposition.**
Let $h\colon \mathbf{F} \twoheadrightarrow \mathbf{M_3}$ be the epimorphism generated by $x\mapsto a, \; y\mapsto b, \; z\mapsto c$.

Then $\ker h$ is not finitely generated.
