...
\noindent {\it Proof of claim in Ex 3.} Let the universe of $\mathbf{L} = \mathbf{2} \times \mathbf{2}$ be $\{0, a, b, 1\}$, where $a\vee b = 1$ and $a\wedge b = 0$.  
...
\noindent {\it Proof of claim in Ex 4.} 

{\bf To Do:} fill in proof.
