...
\noindent Notice that
\begin{align*}
m_{x, 0} &= x, \quad m_{y, 0} = y,  \quad m_{z, 0} = z \\
m_{0, 0} &= (x\wedge y) \vee (x\wedge z)\vee (y\wedge z)\\
m_{x, 1} &= x \vee (y \wedge z), \quad m_{y, 1} = y \vee (x \wedge z),  \quad m_{z, 1} = z \vee (x \wedge y)\\  
m_{0, 1} &= 
 (m_{x,1} \wedge m_{y,1}) \vee (m_{x,1} \wedge m_{z,1})\vee (m_{y,1} \wedge m_{z,1})\\
% m_{0, 1} &= 
% \bigl\{\bigl[x \vee (y \wedge z)\bigr] \wedge \bigl[y \vee (x \wedge z)\bigr]\bigr\} 
% \vee 
% \bigl\{\bigl[x \vee (y \wedge z)\bigr] \wedge \bigl[z \vee (x \wedgeyz)\bigr]\bigr\} 
% \vee 
% \bigl\{\bigl[y \vee (x \wedge z)\bigr] \wedge \bigl[z \vee (x \wedgeyz)\bigr]\bigr\} \\
% m_{x, 2} &= (x \vee (y \wedge z)) \vee (y \vee (x \wedge z)) \vee (z \vee (x \wedge y)\\  
m_{x, 2} &= x \vee (y \wedge z) \vee \bigl\{\bigl[y \vee (x \wedge z)\bigr] \wedge \bigl[z \vee (x \wedge y)\bigr]\bigr\}\\  
& \vdots\\
m_{x, i+1} &= m_{x,i} \vee (m_{y,i} \wedge m_{z,i})
\end{align*}
