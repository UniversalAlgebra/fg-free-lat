...
\bigskip
The induction should go like this: Suppose the result holds for all $(p, q)$ such that $p$ has complexity at most $k$.
Let $(p, q) = (p_1\vee p_2, q_1 \vee q_2)$, where $p_1$ and $p_2$ have complexity at most $k$.
